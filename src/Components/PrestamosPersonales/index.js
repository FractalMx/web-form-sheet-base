    ...
    >
      ...
      <Modal open={modalOpen} onClose={handleCloseModal}>
        <div className="modal-content">
          ...
          >
            * Recuerda que la aprobación de tu préstamo dependerá de la base de
            datos en los últimos meses de tu reporte financiero, si cuentas con
            un mal historial crediticio, se rechazará tu solicitud. En caso de
            aprobar nos pondremos en contacto contigo.
          </Typography>
        </div>
      </Modal>
    </Box>
