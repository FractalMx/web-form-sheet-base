...
const EmprendedorLoansSection = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios({
      ...
      .then((response) => {
        setAlert({
          message: "Su solicitud fue realizada con éxito.",
          status: "success",
          open: true,
        });
        handleCloseModal();
          ...
          <div style={styles.modalContent}>
            ...
            <form onSubmit={handleSubmit}>
              <Grid container spacing={2}>
                ...
                {/* Nombre del Negocio (mostrado solo si tieneNegocio es true) */}
...
export default EmprendedorLoansSection;
